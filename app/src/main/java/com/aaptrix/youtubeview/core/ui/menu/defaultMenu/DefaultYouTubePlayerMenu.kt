package com.aaptrix.youtubeview.core.ui.menu.defaultMenu
...
import com.aaptrix.youtubeview.core.ui.menu.MenuItem
...
internal class DefaultYouTubePlayerMenu(private val context: Context) : YouTubePlayerMenu {
    ...
    override fun show(anchorView: View) {
        ...
        popupWindow?.showAsDropDown(anchorView,-context.resources.getDimensionPixelSize(R.dimen.ayp_8dp) * 12, -context.resources.getDimensionPixelSize(R.dimen.ayp_8dp) * 12, Gravity.BOTTOM)
