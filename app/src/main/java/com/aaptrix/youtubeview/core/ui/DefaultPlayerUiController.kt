package com.aaptrix.youtubeview.core.ui
...
import com.aaptrix.youtubeview.core.player.views.LegacyYouTubePlayerView
import com.aaptrix.youtubeview.core.ui.menu.YouTubePlayerMenu
import com.aaptrix.youtubeview.core.ui.menu.defaultMenu.DefaultYouTubePlayerMenu
import com.aaptrix.youtubeview.core.ui.utils.FadeViewHelper
import com.aaptrix.youtubeview.core.ui.views.YouTubePlayerFastForwardRewind
...
internal class DefaultPlayerUiController(private val youTubePlayerView: LegacyYouTubePlayerView, private val youTubePlayer: YouTubePlayer) : PlayerUiController, YouTubePlayerListener, YouTubePlayerFullScreenListener, YouTubePlayerSeekBarListener {
    ...
    init {
        ...
        onMenuButtonClickListener = View.OnClickListener { youTubePlayerMenu.show(playPauseButton) }
