...
public class SubjectListAdapter extends ArrayAdapter<DataBeanStudent> {
    ...
    public SubjectListAdapter(Activity context, int resource, ArrayList<DataBeanStudent> objects, boolean IsVisible) {
    ...
    private void saveDataInSP(ArrayList<String> stringArray, View view, ArrayList<DataBeanStudent> studentArray) {
        ...
        se_dairy.clear();
        se_dairy.putString("subject", "" + myCustomArray);
        se_dairy.putString("subjectArray", "" + studentArray1);
        se_dairy.apply();
