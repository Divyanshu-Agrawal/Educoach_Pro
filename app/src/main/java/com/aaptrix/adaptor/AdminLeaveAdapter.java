...
import com.aaptrix.activitys.admin.AdminStaffLeave;
...
public class AdminLeaveAdapter extends ArrayAdapter<DataBeanLeaves> {
	...
	public AdminLeaveAdapter(Context context, int resource, ArrayList<DataBeanLeaves> objects, String userType, Activity activity) {
	...
	public class SubmitStatus extends AsyncTask<String, String, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("{\"result\":null}")) {
				...
				Intent i = new Intent(ctx, AdminStaffLeave.class);
